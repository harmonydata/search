...
export default function LinkPreviewCard({ url, compact = false, maxHeight = 250 }: LinkPreviewCardProps) {
    ...
    >
      ...
      <Box sx={{ 
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          >
            {ogData.siteName || new URL(ogData.finalUrl || ogData.url).hostname}
          </Typography>
